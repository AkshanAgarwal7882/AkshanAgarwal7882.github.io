class ScrollerVis {
  ...
  initVis() {
    ...
    // Store the longest assignment (changed from longestHike)
 ...
 vis.rect.transition()
  ...
  step4() {
    ...
    //top 5 assignments into a bar chart (changed from distance to time)
    vis.rect
        .attr('fill', vis.colorScale('default'))
    ...
    //assignment name changed from d.trail
    ...
    // time value changed from d.distance)
    vis.textG.append('text')
